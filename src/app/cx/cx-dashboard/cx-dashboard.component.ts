...
@Component({
  ...
  templateUrl: './cx-dashboard.component.html',
  styleUrls: ['./cx-dashboard.component.scss'],

})
export class CxDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsCxQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/cx/get-dashboard-cx-qua/datatable",
      pathDownload: "Api/v1/cx/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/cx/get-dashboard-cx-comp/datatable",
      pathDownload: "Api/v1/cx/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardCx();
     await this.getDashboardCxQua();
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsCxQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsCxCompDashboard', true);
  }

  filterGrafik(){
   this.getDashboardCx();
   this.getDashboardCxQua()
  }
  ...
  async getDashboardCx() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/cx/dashboard-cxbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardCxQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/cx/dashboard-cxbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
