...
@Component({
  selector: 'app-food-looks-dashboard',
  templateUrl: './food-looks-dashboard.component.html',
  styleUrls: ['./food-looks-dashboard.component.scss'],

})
export class FoodLooksDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsFoodLooksQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/food-looks/get-dashboard-foodlooks-qua/datatable",
      pathDownload: "Api/v1/food-looks/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/food-looks/get-dashboard-foodlooks-comp/datatable",
      pathDownload: "Api/v1/food-looks/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     this.getDashboardFoodLooks();
     this.getDashboardFoodLooksQua();
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsFoodLooksQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsFoodLooksCompDashboard', true);
  ...
  async getDashboardFoodLooks() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/food-looks/dashboard-foodlooksbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardFoodLooksQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/food-looks/dashboard-foodlooksbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/food-looks/importRawData`,
