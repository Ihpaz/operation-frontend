...
@Component({
  ...
  templateUrl: './food-looks.component.html',
  styleUrls: ['./food-looks.component.css']
})
export class FoodlooksComponent implements OnInit {
  ...
  tblSchema: any =  {
    ...
    requestOptions: {
      path: "Api/v1/food-looks/datatable",
      params: []
    },
