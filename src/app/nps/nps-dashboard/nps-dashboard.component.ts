...
export class NpsDashboardComponent implements OnInit {
  ...
  tblSchema: any =  {
    ...
    requestOptions: {
      path: "Api/v1/nps/get-dashboard-nps-qua/datatable",
      pathDownload: "Api/v1/nps/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/nps/get-dashboard-nps-comp/datatable",
      pathDownload: "Api/v1/nps/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardNps();
     await this.getDashboardNpsQua();
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsNpsQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsNpsCompDashboard', true);
  }

  filterGrafik(){
   this.getDashboardNps();
   this.getDashboardNpsQua()
  }
  ...
  async getDashboardNps() {
    try {
      ...
      let url='Api/v1/nps/dashboard-npsbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardNpsQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/nps/dashboard-npsbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
