...
@Component({
  selector: 'app-pest-dashboard',
  templateUrl: './pest-dashboard.component.html',
  styleUrls: ['./pest-dashboard.component.scss'],

})
export class PestDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsPestQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/pest/get-dashboard-pest-qua/datatable",
      pathDownload: "Api/v1/pest/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/pest/get-dashboard-pest-comp/datatable",
      pathDownload: "Api/v1/pest/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardPest();
     await this.getDashboardPestQua();
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsPestQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsPestCompDashboard', true);
  }

  filterGrafik(){
   this.getDashboardPest();
   this.getDashboardPestQua()
  }
  ...
  async getDashboardPest() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/pest/dashboard-pestbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardPestQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/pest/dashboard-pestbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
