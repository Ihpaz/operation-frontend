...
export class StorageDashboardComponent implements OnInit {
  ...
  tblSchema: any =  {
    ...
    requestOptions: {
      path: "Api/v1/storage-cheklist/get-dashboard-storage-qua/datatable",
      pathDownload: "Api/v1/storage-cheklist/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/storage-cheklist/get-dashboard-storage-comp/datatable",
      pathDownload: "Api/v1/storage-cheklist/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     this.getDashboardStorage();
     this.getDashboardStorageQua()
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsStorageQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsStorageCompDashboard', true);
  }
  ...
  async getDashboardStorage() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/storage-cheklist/dashboard-storagebar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardStorageQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/storage-cheklist/dashboard-storagebar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/storage-cheklist/importRawData`,
