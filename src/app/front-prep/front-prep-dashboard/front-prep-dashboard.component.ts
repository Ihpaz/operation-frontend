...
@Component({
  selector: 'app-front-prep-dashboard',
  templateUrl: './front-prep-dashboard.component.html',
  styleUrls: ['./front-prep-dashboard.component.scss']
})
export class FrontPrepDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
 
  tblSchema2: any =  {
    name: "MsFrontCompDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/front-prep/get-dashboard-frontprep-comp/datatable",
      pathDownload: "Api/v1/front-prep/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
 ...
 year:number[]=[];
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsFrontCompDashboard', true);
  }
  ...
  async getDashboardFrontPrep() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/front-prep/dashboard-frontprepbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardFrontPrepQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/front-prep/dashboard-frontprepbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  filterGrafik(){
   ...
   async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/front-prep/importRawData`,
