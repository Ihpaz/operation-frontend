...
@Component({
  selector: 'app-sam-w-dropdown',
  templateUrl: './sam-w-dropdown.component.html',
  styleUrls: ['./sam-w-dropdown.component.scss']
})
export class SamWDropdownComponent implements OnInit {
  ...
  constructor(
    public _dialogRef: MatDialogRef<SamWDropdownComponent>,
    private _globalService: GlobalService,
    @Inject(MAT_DIALOG_DATA) public data: ISAMDropdown,
  ) { }
