...
@Component({
  selector: 'app-suhu',
  templateUrl: './suhu.component.html',
  styleUrls: ['./suhu.component.css']
})
export class SuhuComponent implements OnInit {
  ...
  onFilter() {
    this._globalService.eventPublish('loadTableSAM:MsSuhu', true);
  }
  ...
  async deleteForm(action) {
    ...
    if (alertData.isYes) {
      try {
        ...
        await this._globalService.eventPublish('loadTable:MsSuhu', true);
