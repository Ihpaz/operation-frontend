...
@Component({
  selector: 'app-soup-quality-dashboard',
  templateUrl: './soup-quality-dashboard.component.html',
  styleUrls: ['./soup-quality-dashboard.component.scss']
})
export class SoupQualityDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsSoupQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/soup-quality/get-dashboard-soup-qua/datatable",
      pathDownload: "Api/v1/soup-quality/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/soup-quality/get-dashboard-soup-comp/datatable",
      pathDownload: "Api/v1/soup-quality/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardSoup();
     await this.getDashboardSoupQua()
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsSoupQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsSoupCompDashboard', true);
  }
  ...
  async getDashboardSoup() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/soup-quality/dashboard-soupbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardSoupQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/soup-quality/dashboard-soupbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  filterGrafik(){
    this.getDashboardSoup();
    this.getDashboardSoupQua();
   }
   ...
   async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/soup-quality/importRawData`,
