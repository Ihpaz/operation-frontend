...
export class AttendanceDashboardComponent implements OnInit {
  ...
  tblSchema: any =  {
    ...
    requestOptions: {
      path: "Api/v1/attendance/get-dashboard-attendance-qua/datatable",
      pathDownload: "Api/v1/soup-quality/url-download-voabyday",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    name: "MsAttendanceCompDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/attendance/get-dashboard-attendance-comp/datatable",
      pathDownload: "Api/v1/attendance/url-download-voabyday",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardAttendance();
     await this.getDashboardAttendanceQua();
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsAttendanceQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsAttendanceCompDashboard', true);
  }

  filterGrafik(){
      this.getDashboardAttendance();
      this.getDashboardAttendanceQua();
   }
  ...
  async getDashboardAttendance() {
    try {
      ...
      let url='Api/v1/Attendance/dashboard-attendancebar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardAttendanceQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/Attendance/dashboard-attendancebar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/attendance/importRawData`,
