...
@Component({
  selector: 'app-redbill-dashboard',
  templateUrl: './redbill-dashboard.component.html',
  styleUrls: ['./redbill-dashboard.component.scss'],

})
export class RedbillDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsRedbillQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/redbill/get-dashboard-redbill-qua/datatable",
      pathDownload: "Api/v1/redbill/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/redbill/get-dashboard-redbill-comp/datatable",
      pathDownload: "Api/v1/redbill/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     this.getDashboardRedbill();
     this.getDashboardRedbillQua()
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsRedbillQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsRedbillCompDashboard', true);
  }
  ...
  async getDashboardRedbill() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/redbill/dashboard-redbillbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardRedbillQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/redbill/dashboard-redbillbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
