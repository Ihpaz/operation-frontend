...
@Component({
  ...
  styleUrls: ['./receiving-dashboard.component.scss']
})
export class ReceivingDashboardComponent implements OnInit {
  ...
  tblSchema: any =  {
    ...
    requestOptions: {
      path: "Api/v1/receiving/get-dashboard-receiving-qua/datatable",
      pathDownload: "Api/v1/receiving/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/receiving/get-dashboard-receiving-comp/datatable",
      pathDownload: "Api/v1/receiving/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
     ...
     await this.getAm();
     await this.getDashboardReceiving();
     await this.getDashboardReceivingQua()
  }



  filter(){
     this._globalService.eventPublish('loadTable:MsReceivingQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsReceivingCompDashboard', true);
  }

  filterGrafik(){
    this.getDashboardReceiving();
    this.getDashboardReceivingQua();
   }
  ...
  async getDashboardReceiving() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/receiving/dashboard-receivingbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardReceivingQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/receiving/dashboard-receivingbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getData() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/receiving/importRawData`,
  ...
  async getDataCk() {
    try {
      ...
      const req = await this._globalService.runRequest(
        'POST',
        `api/v1/receiving/importRawDataCk`,
      );
