...
@Component({
  selector: 'app-closing-dashboard',
  templateUrl: './closing-dashboard.component.html',
  styleUrls: ['./closing-dashboard.component.scss'],

})
export class ClosingDashboardComponent implements OnInit {
  @ViewChild(BaseChartDirective) chart: BaseChartDirective | undefined;
  @ViewChild('chartCanvas') chartCanvas: ElementRef;
  
  tblSchema: any =  {
    name: "MsClosingQuaDashboard",
    pageSize: [
      10,
      50,
      100
    ...
    requestOptions: {
      path: "Api/v1/closing/get-dashboard-closing-qua/datatable",
      pathDownload: "Api/v1/closing/download-excel-qua",
      params: [ 
      { key: 'Year', value: null },
  ...
  tblSchema2: any =  {
    ...
    requestOptions: {
      path: "Api/v1/closing/get-dashboard-closing-comp/datatable",
      pathDownload: "Api/v1/closing/download-excel-comp",
      params: [ 
      { key: 'Year', value: null },
      { key: 'Bulan', value: null }
    ]
 ...
 year:number[]=[];
  ...
  async ngOnInit() {
    ...
    //  await this.getDashboardSAM();
     ...
     await this.getAm();
     await this.getDashboardClosing();
     await this.getDashboardClosingQua();
  }
  ...
  filter(){
    // this.getDashboardSAM()
     this._globalService.eventPublish('loadTable:MsClosingQuaDashboard', true);
     this._globalService.eventPublish('loadTable:MsClosingCompDashboard', true);
  }

  filterGrafik(){
   this.getDashboardClosing();
   this.getDashboardClosingQua()
  }
  ...
  async getDashboardClosing() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/closing/dashboard-closingbar-comp-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
  ...
  async getDashboardClosingQua() {
    try {
      // this._dynamicService.showLoader();
      let url='Api/v1/closing/dashboard-closingbar-qua-ByMonth';
      const req= await this._globalService.runRequest(
         'POST',
          url,
         [],
